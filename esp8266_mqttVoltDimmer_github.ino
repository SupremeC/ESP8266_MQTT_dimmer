...
#define HOSTNAME "esp8266-UpperStaircaseBox"  //maxLength=32
const char* ssid = "WiFi SSID";
const char* password = "WiFi password";
const int dimmerPin = D1; // Data PIN Assignment on WEMOS D1 R2 https://www.wemos.cc/product/d1.html
char const* commandTopic = "home/staircase/upper/boxlight/set"; // Refer to Home Assistant YAML Configuration component entry
char const* stateTopic = "home/staircase/upper/boxlight/state"; // Refer to Home Assistant YAML Configuration component entry
char const* statusTopic = "home/staircase/upper/boxlight"; // Refer to Home Assistant YAML Configuration component entry
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if (topicStr == commandTopic)
  {
    ...
    const double rate = 9.515151515; //   1024-82/99
    int dimmerVal = 82 + (rate * (atof(pl.c_str()) - 1));
    if (dimmerVal < 82) {
      // The light is OFF = 0
      dimmerVal = 0;
      state = "0";
